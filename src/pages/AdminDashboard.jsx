...
function AdminDashboard() {
  ...
  return (
    ...
    >
      {/* Overlay gelap untuk membantu keterbacaan */}
        ...
        >
          ...
          >
            ...
            <p className="text-sm text-gray-600 mt-3">
              Tambahkan akun baru untuk petugas dengan mudah dan cepat.
            </p>
            <Link to="/RegistrasiPetugas">
          ...
          >
            ...
            <p className="text-sm text-gray-600 mt-3">
              Kelola data barang dengan lebih efisien dan terintegrasi.
            </p>
          ...
          >
            ...
            <p className="text-sm text-gray-600 mt-3">
              Pantau dan update stok barang secara real-time.
            </p>
          ...
          >
            ...
            >
              ...
              <p className="text-gray-600 mb-6 text-center">
                Apakah Anda yakin ingin keluar dari akun Admin? Pastikan semua
                data telah disimpan.
              </p>
